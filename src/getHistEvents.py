...
# Define the URL
url = "https://data.colonialcollections.nl/nmvw/collection-archives/download.trig.gz?graph=https%3A%2F%2Fdata.colonialcollections.nl%2Fnmvw%2Fgraph%2FhistEvents"

# Define file names
gz_file = "data/histEvents.trig.gz"
trig_file = "data/histEvents.trig"
